...
class categoryClass:
    def __init__(self,root):
        ...
        self.category_table.column("cid",width=15)
        self.category_table.column("name",width=15)
        ...
        #---images---#
        self.im1=Image.open("images/cat_image1.jpg")
        ...
        self.im2=Image.open("images/cat_image2.jpg")
        self.im2=self.im2.resize((500,300),Image.ANTIALIAS)
        self.im2=ImageTk.PhotoImage(self.im2)

        self.lbl_im2=Label(self.root,image=self.im2,bd=2,relief=RAISED)
        self.lbl_im2.place(x=620,y=220)
