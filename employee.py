...
class employeeClass:
    def __init__(self,root):
        ...
        searchframe.place(x=325,y=20,width=600,height=70)
        ...
        # -------------------------title-----------------------
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="#0f4d7d",fg="white").place(x=50,y=100,width=1120)
        ...
        cmb_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Female","Others"),state='readonly',justify=CENTER,font=("goudy old style",12))
        ...
        txt_name=Entry(self.root,textvariable=self.var_email,font=("goudy old style",15),bg="lightyellow").place(x=150,y=230,width=180)
        ...
        cmb_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Select","Admin","Employee"),state='readonly',justify=CENTER,font=("goudy old style",12))
        ...
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="darkgreen",cursor='hand2',fg="white").place(x=500,y=305,width=110,height=28)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="blue",cursor='hand2',fg="white").place(x=620,y=305,width=110,height=28)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="red",cursor='hand2',fg="white").place(x=740,y=305,width=110,height=28)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="grey",cursor='hand2',fg="white").place(x=860,y=305,width=110,height=28)
        ...
        emp_frame.place(x=0,y=330,relwidth=1,height=270)
        ...
        self.EmployeeTable=ttk.Treeview(emp_frame,columns=("eid","name","email","gender","contact","dob","doj","pswd","utype","address","salary"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        ...
        self.EmployeeTable.heading("pswd",text="Pswd")
        self.EmployeeTable.heading("utype",text="User")
        ...
        self.EmployeeTable.column("pswd",width=100)
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row!=None:
                    ...
                    cur.execute("Insert into employee (eid,name,email,gender,contact,dob,doj,pswd,utype,address,salary)values(?,?,?,?,?,?,?,?,?,?,?)",(
                        self.var_emp_id.get(),
                        self.var_name.get(),
                        self.var_email.get(),
                        self.var_gender.get(),
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    cur.execute("Update employee set name=?,email=?,gender=?,contact=?,dob=?,doj=?,pswd=?,utype=?,address=?,salary=? where eid=?",(
